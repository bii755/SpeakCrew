			...
			<li>
				<div id="co_<?php echo $row['co_no']?>" class="commentSet">
					<div class="commentInfo">
						...
						<div class="h4 text-muted"><span class="coId"><?php echo $row['co_id']." :"?></span></div>
						<div class="h5">
                            <p class="text-right">
							<a href="#" class="comt write">댓글</a>
							<a href="#" class="comt modify">수정</a>
							<a href="#" class="comt delete">삭제</a></p>
						</div>
					</div>
					<div class="commentContent"><br><?php echo $row['co_content']?></div>
				</div>
				<?php
